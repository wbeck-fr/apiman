...
module ApimanPageLifecycle {
    ...
    export var pageTitles = {
        "page.title.admin-gateways": "Bridge Gateway - Admin - Gateways",
        "page.title.admin-plugins": "Bridge Gateway - Admin - Plugins",
        "page.title.admin-roles": "Bridge Gateway - Admin - Roles",
        "page.title.admin-policyDefs": "Bridge Gateway - Admin - Policy Definitions",
        "page.title.admin-export": "Bridge Gateway - Admin - Export/Import",
        "page.title.api-catalog": "Bridge Gateway - API Catalog",
        "page.title.api-catalog-def": "Bridge Gateway - API Definition",
        "page.title.client-activity": "Bridge Gateway - {0} (Change Log)",
        "page.title.client-apis": "Bridge Gateway - {0} (APIs)",
        "page.title.client-contracts": "Bridge Gateway - {0} (Contracts)",
        "page.title.client-metrics": "Bridge Gateway - {0} (Metrics)",
        "page.title.client-overview": "Bridge Gateway - {0} (Overview)",
        "page.title.client-policies": "Bridge Gateway - {0} (Policies)",
        "page.title.consumer-org": "Bridge Gateway - Organization {0}",
        "page.title.consumer-orgs": "Bridge Gateway - Organizations",
        "page.title.consumer-api": "Bridge Gateway - API {0}",
        "page.title.consumer-api-def": "Bridge Gateway - API {0} - Definition",
        "page.title.consumer-apis": "Bridge Gateway - APIs",
        "page.title.dashboard": "Bridge Gateway - Home",
        "page.title.about": "Bridge Gateway - About",
        "page.title.edit-gateway": "Bridge Gateway - Edit Gateway",
        "page.title.edit-policy": "Bridge Gateway - Edit Policy",
        "page.title.edit-policyDef": "Bridge Gateway - Edit Policy Definition",
        "page.title.edit-role": "Bridge Gateway - Edit Role",
        "page.title.import-policyDefs": "Bridge Gateway - Import Policy Definition(s)",
        "page.title.import-apis": "Bridge Gateway - Import API(s)",
        "page.title.new-client": "Bridge Gateway - New Client App",
        "page.title.new-client-version": "Bridge Gateway - New Client App Version",
        "page.title.new-contract": "Bridge Gateway - New Contract",
        "page.title.new-gateway": "Bridge Gateway - New Gateway",
        "page.title.new-member": "Bridge Gateway - Add Member",
        "page.title.new-org": "Bridge Gateway - New Organization",
        "page.title.new-plan": "Bridge Gateway - New Plan",
        "page.title.new-plan-version": "Bridge Gateway - New Plan Version",
        "page.title.new-plugin": "Bridge Gateway - Add Plugin",
        "page.title.new-policy": "Bridge Gateway - Add Policy",
        "page.title.new-role": "Bridge Gateway - New Role",
        "page.title.new-api": "Bridge Gateway - New API",
        "page.title.new-api-version": "Bridge Gateway - New API Version",
        "page.title.org-activity": "Bridge Gateway - {0} (Change Log)",
        "page.title.org-clients": "Bridge Gateway - {0} (Client Apps)",
        "page.title.org-manage-members": "Bridge Gateway - {0} (Manage Members)",
        "page.title.org-members": "Bridge Gateway - {0} (Members)",
        "page.title.org-plans": "Bridge Gateway - {0} (Plans)",
        "page.title.org-apis": "Bridge Gateway - {0} (APIs)",
        "page.title.plan-activity": "Bridge Gateway - {0} (Change Log)",
        "page.title.plan-overview": "Bridge Gateway - {0} (Overview)",
        "page.title.plan-policies": "Bridge Gateway - {0} (Policies)",
        "page.title.plugin-details": "Bridge Gateway - Plugin Details",
        "page.title.policy-defs": "Bridge Gateway - Admin - Policy Definitions",
        "page.title.api-activity": "Bridge Gateway - {0} (Change Log)",
        "page.title.api-contracts": "Bridge Gateway - {0} (Contracts)",
        "page.title.api-endpoint": "Bridge Gateway - {0} (Endpoint)",
        "page.title.api-metrics": "Bridge Gateway - {0} (Metrics)",
        "page.title.api-impl": "Bridge Gateway - {0} (Implementation)",
        "page.title.api-def": "Bridge Gateway - {0} (Definition)",
        "page.title.api-overview": "Bridge Gateway - {0} (Overview)",
        "page.title.api-plans": "Bridge Gateway - {0} (Plans)",
        "page.title.api-policies": "Bridge Gateway - {0} (Policies)",
        "page.title.user-activity": "Bridge Gateway - {0} (Change Log)",
        "page.title.user-clients": "Bridge Gateway - {0} (Client Apps)",
        "page.title.user-orgs": "Bridge Gateway - {0} (Organizations)",
        "page.title.user-profile": "Bridge Gateway - User Profile",
        "page.title.user-apis": "Bridge Gateway - {0} (APIs)",
        "page.title.error": "Bridge Gateway - {0} Error",
    };
