...
module ApimanPageLifecycle {
    ...
    export var pageTitles = {
        ...
        "page.title.new-client": "Bridge Gateway - New Client",
        "page.title.new-client-version": "Bridge Gateway - New Client Version",
        ...
        "page.title.org-clients": "Bridge Gateway - {0} (Client)",
        ...
        "page.title.user-clients": "Bridge Gateway - {0} (Clients)",
